...
Процедура ПриЗаполненииПоставляемыхПрофилейГруппДоступа(ОписанияПрофилей, ПараметрыОбновления) Экспорт
	...
	ОписаниеПрофиля.Идентификатор = "1a2b3c4d-5e6f-7890-abcd-ef1234560001";
	...
	ОписаниеПрофиля.Роли.Добавить("СохранениеДанныхПользователя");
	ОписаниеПрофиля.Роли.Добавить("БазоваяФункциональностьТП");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ОбслуживаниеКлиентовПользователь");
	ОписанияПрофилей.Добавить(ОписаниеПрофиля);
	
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя           = "Менеджер";
	ОписаниеПрофиля.Идентификатор = "1a2b3c4d-5e6f-7890-abcd-ef1234560002";
	...
	ОписаниеПрофиля.Идентификатор = "1a2b3c4d-5e6f-7890-abcd-ef1234560003";
	...
	ОписаниеПрофиля.Идентификатор = "e6f7a8b9-c0d1-4e2f-3a4b-5c6d7e8f9a01";
